...
#define RF69_CSMA_LIMIT_MS 100  // war 1000
#define RF69_TX_LIMIT_MS   100  // war 1000
...
//    void setCS(uint8_t newSPISlaveSelect); Funktion wird nicht benötigt
    ...
    static volatile bool _haveData; // war protected, dann kann aber die Interruptfunktion nicht darauf zugreifen
